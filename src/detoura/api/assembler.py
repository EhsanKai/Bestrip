...
def recommendation_dto(
    ...
    *,
    ...
    return TripRecommendation(
        ...
        intercity_minutes=itinerary.total_travel_minutes,
        total_transit_minutes=itinerary.total_transport_minutes,
        usable_minutes=itinerary.usable_destination_minutes,
