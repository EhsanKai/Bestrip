...
class TransportOption(BaseModel):
    ...
    """Where this price came from and when (V5.3).

    ``None`` means no provenance - which is what the synthetic providers
    report, honestly, because their prices are fabricated. It is not the same
